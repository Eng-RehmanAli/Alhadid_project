...
export function HomeHero({ featureStrip, glassStats }: HomeHeroProps) {
  ...
  return (
    <section className="relative isolate overflow-hidden grid-scene pb-28 pt-6 text-white md:pb-36 md:pt-10">
      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-10 px-5 lg:grid-cols-2 lg:gap-16 md:px-8">
        ...
        <div className="relative mx-auto w-full max-w-[360px] perspective-[1200px] sm:max-w-md lg:max-w-none">
          ...
          <div className="relative mx-auto aspect-[4/5] w-full max-w-[420px]">
            ...
            >
              <div className="relative h-full w-full overflow-hidden rounded-[1.5rem] border border-white/20 bg-teal-deep/40 shadow-[0_30px_80px_rgba(0,40,45,0.45)] sm:rounded-[2rem]">
                <Image
                  src={heroImage}
            ...
            <StatPop
              immediate
              delayMs={780}
              className="absolute left-0 top-6 z-10 w-[46%] sm:-left-4 sm:top-8 sm:w-[46%] lg:-left-6"
            >
              <TiltCard float className="rounded-2xl p-2.5 sm:p-4">
                <p className="text-[0.6rem] uppercase tracking-[0.14em] text-white/70 sm:text-[0.65rem]">
                  {glassStats[0].label}
                </p>
                <p className="mt-1 font-[family-name:var(--font-display)] text-xl font-bold text-white sm:text-2xl">
            ...
            <StatPop
              immediate
              delayMs={900}
              className="absolute right-0 top-[38%] z-10 w-[48%] sm:-right-4 sm:w-[48%] lg:-right-8"
            >
              <TiltCard float className="rounded-2xl p-2.5 sm:p-4" maxTilt={12}>
                <p className="text-[0.6rem] uppercase tracking-[0.14em] text-white/70 sm:text-[0.65rem]">
                  {glassStats[1].label}
                </p>
                <p className="mt-1 font-[family-name:var(--font-display)] text-xl font-bold text-white sm:text-2xl">
            ...
            <StatPop
              immediate
              delayMs={1020}
              className="absolute bottom-4 left-[6%] z-10 w-[58%] sm:bottom-10 sm:left-[4%] sm:w-[52%]"
            >
              <TiltCard float className="rounded-2xl p-2.5 sm:p-4" maxTilt={8}>
                <p className="text-[0.6rem] uppercase tracking-[0.14em] text-white/70 sm:text-[0.65rem]">
                  {glassStats[2].label}
                </p>
                <p className="mt-1 font-[family-name:var(--font-display)] text-xl font-bold text-white sm:text-2xl">
      ...
      <div className="relative z-10 mx-auto -mb-20 mt-14 max-w-6xl px-5 md:-mb-28 md:mt-20 md:px-8">
